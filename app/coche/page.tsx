...
export default function CochePage() {
  const cocheTools = tools.filter((tool) => tool.category === "coche");
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <h1 className="text-4xl font-bold tracking-tight sm:text-5xl">
            Calculadoras de coche y viajes
          </h1>

          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-gray-600">
            Herramientas sencillas para calcular consumos, costes de
            combustible y gastos de tus viajes.
          </p>
        </div>
        ...
        <article className="mt-16 rounded-2xl border border-gray-200 bg-white p-6 sm:p-8">
          ...
          <p className="mt-4 leading-7 text-gray-600">
            En esta sección encontrarás herramientas para calcular
            diferentes aspectos relacionados con el uso del coche y
            los viajes. Puedes calcular el consumo de tu vehículo,
            estimar el coste del combustible o conocer cuánto te cuesta
            recorrer cada kilómetro.
          </p>

          <p className="mt-4 leading-7 text-gray-600">
            Introduce los datos de tu vehículo y obtén el resultado de
